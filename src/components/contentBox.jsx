...
const ContentLanding = () => {
  return (
    <div className="bg-[#F3EFE6] px-14 py-10 flex flex-col">
      ...
      <div className="grid  md:grid-cols-2 sm-grid-cols-1">
        <div>
          <p className="text-[#898F83] w-auto mt-4">
          ...
          <p className="text-[#898F83] w-auto mt-4 mb-4">
            A perfect choice for VIP gifting, premium décor, and memorable
            celebrations — finished in natural wood tones with intricate
            hand-relief carving across every surface.
          </p>
        </div>
      </div>
